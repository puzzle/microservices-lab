...
{{% alert title="Prebuilt Container" color="info" %}} The prebuilt version of
...
To change to the LRA version, switch to the prebuilt docker images.
...
### Task {{% param sectionnumber %}}.2 - Rerun tests from previous section

* Do the changes solve the consistency issues?
