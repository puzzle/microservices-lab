...
{{% alert title="PanacheEntity" color="primary" %}} We are using the Quarkus Hibernate ORM with Panache extension. The
...
### Task {{% param sectionnumber %}}.6 - Rest Client
